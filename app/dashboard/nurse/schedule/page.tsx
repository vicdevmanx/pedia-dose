...
import { Calendar, Clock, User, Pill, CheckCircle, AlertTriangle, Search } from "lucide-react"
...
export default function MedicationSchedulePage() {
  ...
  const handleAdminister = (med: MedicationSchedule) => {
    setMedications((prev) =>
      prev.map((m) => (m.id === med.id ? { ...m, status: "completed" as const, notes: administrationNotes } : m)),
    )
                    ...
                    {(med.status === "pending" || med.status === "overdue") && (
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button
                            size="sm"
                            variant={med.status === "overdue" ? "destructive" : "default"}
                        ...
                        <DialogContent className="max-w-[95vw] sm:max-w-md">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                              <label className="text-sm font-medium">Side Effects (if any)</label>
                              <Textarea
